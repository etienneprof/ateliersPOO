package tp8.again.medecin.mauvaiseversion2.test;

import java.time.LocalDate;

import tp8.again.medecin.mauvaiseversion2.bo.MedecinSpecialiste;
import tp8.again.medecin.mauvaiseversion2.bo.Adresse;
import tp8.again.medecin.mauvaiseversion2.bo.Creneau;
import tp8.again.medecin.mauvaiseversion2.bo.MedecinGeneraliste;
import tp8.again.medecin.mauvaiseversion2.bo.Patient;
import tp8.again.medecin.mauvaiseversion2.bo.RendezVous;
...
public class TestAssociationRendezVous {
	public static void main(String[] args) {
		...
		// Attention ! Ne devrait pas être possible.
		System.out.println(MedecinSpecialiste.getTarif());
